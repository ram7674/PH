...
import Home, { HomeComponent } from "../src/pages/Home/Home";
    ...
    <Router>
      ...
      <Routes>
        <Route path="/" element={<Home />}>
          ...
          <Route
            path="/best-hospital-in-Kukatpally"
            element={<Pragatinagar />}
          />
          <Route path="/doctor/:doctorName" element={<DoctorDetails />} />
          <Route path="/doctors-list" element={<DoctorsList />} />
          <Route
            path="/center-of-excellence/:specialty"
            element={<CentreofExcellence />}
          />
          <Route
            path="/all-you-should-know-about-pneumonia"
            element={<AboutPneumoniaPage />}
          />
          <Route
            path="/choosing-the-right-hospital"
            element={<ChoosingRightHospitalPage />}
          />
          <Route
            path="/life-after-knee-ligament-surgery"
            element={<LifeAfterSurgeryPage />}
          />
          <Route path="/pcod" element={<PcodPage />} />
          <Route
            path="/all-kou-kust-know-about-pregnancy-care"
            element={<AboutPregnancyCarePage />}
          />
